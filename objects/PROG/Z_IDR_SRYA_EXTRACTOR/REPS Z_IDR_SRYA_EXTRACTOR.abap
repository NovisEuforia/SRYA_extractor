...
LOOP AT lt_extract01 INTO lw_extract01.
  ...
  CONCATENATE lw_extract02-tasktype ';'  lw_extract02-account ';'  lw_extract02-tasktdesc ';'  lw_extract02-entry_id   ';'  lw_extract02-count
...
* -TABLE USR01------------------------------------------------------
  SELECT * FROM usr01 INTO TABLE lt_usr01.

OPEN DATASET p_filer5 FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.

LOOP AT lt_usr01 INTO lw_usr01.
