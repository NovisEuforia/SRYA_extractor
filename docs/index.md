...
1. Creación del report **de forma manual:**
   ...
   2. Copiar el código fuente del fichero -REPS Z_IDR_SRYA_EXTRACTOR.abap- ubicado en [objects/PROG/Z_IDR_SRYA_EXTRACTOR/]!(https://github.com/NovisEuforia/SRYA_extractor/blob/master/objects/PROG/Z_IDR_SRYA_EXTRACTOR/REP Z_IDR_SRYA_EXTRACTOR.abap)
